...
/* game caracteristics */ 
#define MAX_GAME_PLIES     511  ///< max ply we can search per position
#define MAX_POSITION_MOVES 255  ///< max pseudo legal moves in one position 
...
enum file_t : uint8_t {FILE_A, FILE_B, FILE_C, FILE_D, FILE_E, FILE_F, FILE_G, FILE_H, FILE_NONE}; ///< defining the file names 
enum rank_t : uint8_t {RANK_1, RANK_2, RANK_3, RANK_4, RANK_5, RANK_6, RANK_7, RANK_8, RANK_NONE}; ///< defining the rank names 
...
#define ISMATE (INFINITE - MAX_DEPTH) ///< mate score if under this limit
